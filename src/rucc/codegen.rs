...
use crate::rucc::lexer::Pos;
use crate::rucc::node;
use crate::rucc::node::Bits;
use crate::rucc::types::{RectypeName, Sign, StorageClass, Type};
...
pub fn retrieve_from_load(ast: &node::AST) -> &node::AST {
    match ast.kind {
